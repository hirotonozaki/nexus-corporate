...
![Responsive](https://img.shields.io/badge/Responsive-Mobile_First-a06bff?style=flat-square)
...
### 6. 外部画像URLに依存しないローカル運用
制作実績のサムネイル画像は、外部画像URLに依存せず、`assets/images/works/` 配下のローカル画像を参照しています。これにより、外部CDNの仕様変更や画像の差し替えによる表示崩れリスクを排除し、リポジトリ単体で完結する状態を維持しています。
...
└── assets/
    └── images/
        ├── preview-mockup.png # PC + スマホ モックアップ
        ├── qr-code.png        # スマホアクセス用 QR
        └── works/             # 制作実績サムネイル（ローカル画像）
            ├── work-01.jpg
            ├── work-02.jpg
            ├── work-03.jpg
            └── work-04.jpg
...
<img src="./assets/images/preview-mockup.png" alt="NEXUS Inc. PC & Mobile Preview" width="100%" />

<sub>PC 表示・スマートフォン表示のモックアップ</sub>
...
<img src="./assets/images/qr-code.png" alt="NEXUS Inc. QR Code" width="220" />

<sub>QR コードを読み取ると、スマートフォン実機でご確認いただけます。<br />
...
> ※本サイトは、ポートフォリオ用に制作した架空企業サイトです。  
> 掲載している企業情報・実績内容・採用情報は、実在の企業情報ではありません。
